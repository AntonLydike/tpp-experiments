...
module {
  ...
  func.func @tpp_deduplicated(%arg0: memref<1024x1024xbf16>, %arg1: memref<1024x1024xbf16>, %arg2: memref<1024x1024xbf16>) {
    ...
    scf.parallel (%arg3, %arg4) = (%c0, %c0) to (%c32, %c32) step (%c4, %c8) {
      ...
      func.call @xsmm_intel_amx_tile_config_invoke(%c2_i64, %2, %6, %c0) : (i64, i64, !llvm.ptr, index) -> ()
      scf.for %arg5 = %c0 to %c4 step %c1 {
      ...
      func.call @xsmm_intel_amx_tile_config_invoke(%c2_i64, %3, %6, %c0) : (i64, i64, !llvm.ptr, index) -> ()
      scf.reduce 
    }
