  ...
  func.func @accfg_deduplicated(%arg0: memref<1024x1024xbf16>, %arg1: memref<1024x1024xbf16>, %arg2: memref<1024x1024xbf16>) {
    ...
    scf.parallel (%arg3, %arg4) = (%c0, %c0) to (%c32, %c32) step (%c4, %c8) {
      scf.for %arg5 = %c0 to %c4 step %c1 {
        %6 = arith.addi %arg5, %arg3 : index
        %7 = affine.apply #map(%6)
        scf.for %arg6 = %c0 to %c8 step %c1 {
          %8 = arith.addi %arg6, %arg4 : index
          %9 = affine.apply #map(%8)
          %subview = memref.subview %arg0[%7, %9] [32, 32] [1, 1] : memref<1024x1024xbf16> to memref<32x32xbf16, strided<[1024, 1], offset: ?>>
          %subview_1 = memref.subview %alloc[%6, %8, 0, 0] [1, 1, 32, 32] [1, 1, 1, 1] : memref<32x32x32x32xbf16> to memref<32x32xbf16, strided<[32, 1], offset: ?>>
          ...
          func.call @xsmm_unary_invoke(%c2_i64, %0, %11, %offset, %13, %offset_3) : (i64, i64, !llvm.ptr, index, !llvm.ptr, index) -> ()
        }
      }
      scf.reduce 
    }
    ...
    scf.parallel (%arg3, %arg4) = (%c0, %c0) to (%c32, %c32) step (%c4, %c8) {
      scf.for %arg5 = %c0 to %c4 step %c1 {
        ...
        scf.for %arg6 = %c0 to %c8 step %c1 {
          %8 = arith.addi %arg6, %arg4 : index
          %9 = affine.apply #map(%8)
          %subview = memref.subview %arg1[%9, %7] [32, 32] [1, 1] : memref<1024x1024xbf16> to memref<32x32xbf16, strided<[1024, 1], offset: ?>>
          %subview_1 = memref.subview %alloc_0[%6, %8, 0, 0, 0] [1, 1, 16, 32, 2] [1, 1, 1, 1, 1] : memref<32x32x16x32x2xbf16> to memref<16x32x2xbf16, strided<[64, 2, 1], offset: ?>>
          %base_buffer, %offset, %sizes:2, %strides:2 = memref.extract_strided_metadata %subview : memref<32x32xbf16, strided<[1024, 1], offset: ?>> -> memref<bf16>, index, index, index, index, index
          %intptr = memref.extract_aligned_pointer_as_index %subview : memref<32x32xbf16, strided<[1024, 1], offset: ?>> -> index
          %10 = arith.index_cast %intptr : index to i64
          %11 = llvm.inttoptr %10 : i64 to !llvm.ptr
          ...
          %12 = arith.index_cast %intptr_6 : index to i64
          %13 = llvm.inttoptr %12 : i64 to !llvm.ptr
          func.call @xsmm_unary_invoke(%c2_i64, %1, %11, %offset, %13, %offset_3) : (i64, i64, !llvm.ptr, index, !llvm.ptr, index) -> ()
        }
      }
      scf.reduce 
    }
    ...
    scf.parallel (%arg3, %arg4) = (%c0, %c0) to (%c32, %c32) step (%c4, %c8) {
      ...
      func.call @xsmm_intel_amx_tile_config_invoke(%c2_i64, %3, %7, %c0) : (i64, i64, !llvm.ptr, index) -> ()
      scf.for %arg5 = %c0 to %c4 step %c1 {
      ...
      %8 = func.call @xsmm_intel_amx_tile_config_dispatch(%c2_i64, %c32_i64, %c32_i64, %c32_i64, %c32_i64, %c32_i64, %c1024_i64, %c1024_i64, %c1024_i64, %c2176_i64) : (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64) -> i64
      func.call @xsmm_intel_amx_tile_config_invoke(%c2_i64, %8, %7, %c0) : (i64, i64, !llvm.ptr, index) -> ()
      scf.reduce 
    }
    %5 = call @perf_stop_timer(%2) : (i64) -> f64
    vector.print %5 : f64
    return
  }
}
