  ...
  func.func @accfg_deduplicated(%arg0: memref<1024x1024xbf16>, %arg1: memref<1024x1024xbf16>, %arg2: memref<1024x1024xbf16>) {
    ...
    scf.parallel (%arg3, %arg4) = (%c0, %c0) to (%c32, %c32) step (%c4, %c8) {
      scf.for %arg5 = %c0 to %c4 step %c1 {
        %4 = arith.addi %arg5, %arg3 : index
        %5 = affine.apply #map(%4)
        scf.for %arg6 = %c0 to %c8 step %c1 {
          %6 = arith.addi %arg6, %arg4 : index
          %7 = affine.apply #map(%6)
          %subview = memref.subview %arg0[%5, %7] [32, 32] [1, 1] : memref<1024x1024xbf16> to memref<32x32xbf16, strided<[1024, 1], offset: ?>>
          %subview_1 = memref.subview %alloc[%4, %6, 0, 0] [1, 1, 32, 32] [1, 1, 1, 1] : memref<32x32x32x32xbf16> to memref<32x32xbf16, strided<[32, 1], offset: ?>>
          ...
          func.call @xsmm_unary_invoke(%c2_i64, %0, %9, %offset, %11, %offset_3) : (i64, i64, !llvm.ptr, index, !llvm.ptr, index) -> ()
        }
      }
      scf.reduce 
    }
    ...
    scf.parallel (%arg3, %arg4) = (%c0, %c0) to (%c32, %c32) step (%c4, %c8) {
      scf.for %arg5 = %c0 to %c4 step %c1 {
        ...
        scf.for %arg6 = %c0 to %c8 step %c1 {
          %6 = arith.addi %arg6, %arg4 : index
          %7 = affine.apply #map(%6)
          %subview = memref.subview %arg1[%7, %5] [32, 32] [1, 1] : memref<1024x1024xbf16> to memref<32x32xbf16, strided<[1024, 1], offset: ?>>
          %subview_1 = memref.subview %alloc_0[%4, %6, 0, 0, 0] [1, 1, 16, 32, 2] [1, 1, 1, 1, 1] : memref<32x32x16x32x2xbf16> to memref<16x32x2xbf16, strided<[64, 2, 1], offset: ?>>
          %base_buffer, %offset, %sizes:2, %strides:2 = memref.extract_strided_metadata %subview : memref<32x32xbf16, strided<[1024, 1], offset: ?>> -> memref<bf16>, index, index, index, index, index
          %intptr = memref.extract_aligned_pointer_as_index %subview : memref<32x32xbf16, strided<[1024, 1], offset: ?>> -> index
          %8 = arith.index_cast %intptr : index to i64
          %9 = llvm.inttoptr %8 : i64 to !llvm.ptr
          ...
          %10 = arith.index_cast %intptr_6 : index to i64
          %11 = llvm.inttoptr %10 : i64 to !llvm.ptr
          func.call @xsmm_unary_invoke(%c2_i64, %1, %9, %offset, %11, %offset_3) : (i64, i64, !llvm.ptr, index, !llvm.ptr, index) -> ()
        }
      }
      scf.reduce 
    }
    ...
    %3 = call @xsmm_brgemm_dispatch(%c2_i64, %c32_i64, %c32_i64, %c32_i64, %c32_i64, %c32_i64, %c1024_i64, %c1024_i64, %c1024_i64, %c2240_i64) : (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64) -> i64
    scf.parallel (%arg3, %arg4) = (%c0, %c0) to (%c32, %c32) step (%c4, %c8) {
      ...
      func.call @xsmm_intel_amx_tile_config_invoke(%c2_i64, %2, %5, %c0) : (i64, i64, !llvm.ptr, index) -> ()
      scf.for %arg5 = %c0 to %c4 step %c1 {
        %7 = arith.addi %arg5, %arg3 : index
        %8 = affine.apply #map(%7)
        %subview = memref.subview %alloc[%7, 0, 0, 0] [1, 32, 32, 32] [1, 1, 1, 1] : memref<32x32x32x32xbf16> to memref<32x32x32xbf16, strided<[1024, 32, 1], offset: ?>>
        scf.for %arg6 = %c0 to %c8 step %c1 {
          %9 = arith.addi %arg6, %arg4 : index
          %10 = affine.apply #map(%9)
          %subview_1 = memref.subview %alloc_0[%9, 0, 0, 0, 0] [1, 32, 16, 32, 2] [1, 1, 1, 1, 1] : memref<32x32x16x32x2xbf16> to memref<32x16x32x2xbf16, strided<[1024, 64, 2, 1], offset: ?>>
          %subview_2 = memref.subview %arg2[%8, %10] [32, 32] [1, 1] : memref<1024x1024xbf16> to memref<32x32xbf16, strided<[1024, 1], offset: ?>>
          ...
          func.call @xsmm_brgemm_invoke(%c2_i64, %3, %12, %offset, %14, %offset_5, %16, %offset_10, %c32_i64) : (i64, i64, !llvm.ptr, index, !llvm.ptr, index, !llvm.ptr, index, i64) -> ()
        }
      }
      %6 = func.call @xsmm_intel_amx_tile_config_dispatch(%c2_i64, %c32_i64, %c32_i64, %c32_i64, %c32_i64, %c32_i64, %c1024_i64, %c1024_i64, %c1024_i64, %c2176_i64) : (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64) -> i64
      func.call @xsmm_intel_amx_tile_config_invoke(%c2_i64, %6, %5, %c0) : (i64, i64, !llvm.ptr, index) -> ()
      scf.reduce 
    }
